...
<link href="<?php echo base_url();?>assets/vendor/css/fancybox/jquery.fancybox.css" rel="stylesheet"> 
<link href="<?php echo base_url();?>assets/vendor/css/flexslider.css" rel="stylesheet" /> 
...
<?php $this->load->view("layout/infobanner"); ?>    
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="about-image">
                        <img src="<?php echo base_url();?>assets/vendor/img/about.png" alt="About Images">
                    </div>
                </div>
            </div>
        </div>
                                     ...
                                     <div class="testimonials">
                                        <div class="active item">
                                          ...
                                          <div class="carousel-info">
                                            <img alt="" src="<?php echo base_url();?>assets/vendor/img/team4.jpg" class="pull-left">
                                            <div class="pull-left">
...
<script src="<?php echo base_url();?>assets/vendor/js/jquery.easing.1.3.js"></script>
<script src="<?php echo base_url();?>assets/vendor/js/bootstrap.min.js"></script>
<script src="<?php echo base_url();?>assets/vendor/js/jquery.fancybox.pack.js"></script>
<script src="<?php echo base_url();?>assets/vendor/js/jquery.fancybox-media.js"></script>  
<script src="<?php echo base_url();?>assets/vendor/js/jquery.flexslider.js"></script>
<script src="<?php echo base_url();?>assets/vendor/js/animate.js"></script>
<!-- Vendor Scripts -->
<script src="<?php echo base_url();?>assets/vendor/js/modernizr.custom.js"></script>
<script src="<?php echo base_url();?>assets/vendor/js/jquery.isotope.min.js"></script>
