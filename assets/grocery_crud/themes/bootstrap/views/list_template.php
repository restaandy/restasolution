<?php
    $this->set_css($this->default_theme_path.'/bootstrap/css/bootstrap/bootstrap.min.cssx');
    $this->set_css($this->default_theme_path.'/bootstrap/css/font-awesome/css/font-awesome.min.cssx');    
    ...
    if ($this->config->environment == 'production') {
        ...
        $this->set_js_lib($this->default_theme_path.'/bootstrap/js/bootstrap/dropdown.js');
        //$this->set_js_lib($this->default_theme_path.'/bootstrap/js/bootstrap/modal.js');
...
<script type='text/javascript'>
    ...
    <br/>
    <div class="containerx gc-container">
                ...
                <div class="table-container">
                    <form action="" method="post" autocomplete="off">
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn btn-warning btn-xs" href="<?php echo $add_url?>"><i class="fa fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject?></a>
                                </div>
                            <?php } ?>
                            <div class="floatR">
                                <?php if(!$unset_export) { ?>
                                    <a class="btn btn-default btn-xs t5 gc-export" data-url="<?php echo $export_url; ?>">
                                ...
                                <?php } ?>
                                <?php if(!$unset_print) { ?>
                                    <a class="btn btn-default btn-xs t5 gc-print" data-url="<?php echo $print_url; ?>">
        			    ...
        			    <table class="table table-bordered grocery-crud-table table-hover table-stripped">
        					<thead>
        						<tr>
